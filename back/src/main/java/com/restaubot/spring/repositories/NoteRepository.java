...
public interface NoteRepository extends JpaRepository<NoteEntity, Integer> {
    ...
    List<NoteEntity> findNoteByIdRestaurantAndCustomer(@Param("id_customer") Integer customerId, @Param("id_restaurant") Integer restaurantId);

    @Query("SELECT AVG(a.note) FROM NoteEntity a WHERE a.restaurant.idUser = :idRestaurant")
    Double findAverageNote(@Param("idRestaurant") Integer idRestaurant);
}
